...
O objetivo era desenvolver uma lista com filtros de planetas do universo de Star Wars usando **Context API e Hooks** para controlar os estados globais.
...
1. Clone o repositório
  * `git clone https://github.com/andredebem/starwars-planets-search.git`.
